 ...
 */
package io.github.hajdbc.messages.i18n;
...
public class I18nMessagesProvider implements MessagesProvider
{
	...
	public boolean isEnabled()
	{
		try
		{
			...
			ResourceBundle.getBundle(io.github.hajdbc.messages.i18n.I18nMessages.class.getName());
			return true;
		}
		catch (Throwable e)
		{
	...
	{
		return new I18nMessages(io.github.hajdbc.messages.i18n.I18nMessages.class.getName());
	}

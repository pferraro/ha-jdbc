 ...
 *
 */
public class ArrayProxyFactoryFactory<Z, D extends Database<Z>, P> implements ProxyFactoryFactory<Z, D, P, SQLException, Array, SQLException>
{
	private final boolean locatorsUpdateCopy;
	
	public ArrayProxyFactoryFactory(boolean locatorsUpdateCopy)
	{
